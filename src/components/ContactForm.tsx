...
export default function ContactForm() {
  ...
  return (
    <div className="isolate px-6 py-6 sm:py-12 lg:px-8">
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-4xl">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-shamrock sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
          ...
          <Field as="div" className="flex gap-x-4 sm:col-span-2">
            ...
            <Label className="text-sm leading-6 text-gray-600">
              ...
              <a href="#" className="font-semibold text-shamrock">
                privacy&nbsp;policy
              </a>
              .
            </Label>
