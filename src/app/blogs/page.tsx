...
export const metadata: Metadata = {
  title: 'Pitaku Blog',
  description:
    'Discover insights and tips on how our customer loyalty platform helps small businesses retain loyal customers with meaningful, card-free rewards that drive engagement and sustainability.',
}
...
export default async function Page() {
  const [allBlogs] = await Promise.all([allBlogsLoader()])
