    ...
    <>
      <div className="w-full h-auto min-h-screen bg-white">
        ...
        <div className=" max-w-6xl mx-auto py-10 overflow-y-auto">
          <h1 className="text-2xl text-shamrock font-display font-semibold my-2">
            Privacy Policy
          </h1>

          <h2 className="text-lg text-shamrock font-medium my-1">
            1. Introduction
          </h2>
          <p className="my-4">
            Welcome to {companyName} (“we”, “our”, “us”). We are committed to
            ...
            provide when signing up for our loyalty program SaaS product.
          </p>
          ...
          <p className="my-4">
            When you sign up for our loyalty program, we collect the following
            information:
          </p>
          <ul className="my-4">
            <li>Full Name</li>
          ...
          <ul className="my-4">
            ...
            <li>
              Communicate with you about your account and the services we offer
            </li>
          ...
          <p className="my-4">
            We implement a variety of security measures to ensure your personal
            information is protected. This includes secure servers, encryption,
            and access controls to safeguard your data from unauthorized access
            or disclosure.
          </p>
        </div>
      </div>
